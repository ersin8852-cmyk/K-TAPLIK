  ...
  useEffect(() => {
    if (showCamera) {
      ...
      const videoConstraints = {
        ...
        // 'Zorunlu' (advanced/exact) parametreler yerine 'tercih edilen' (ideal) parametreler veriyoruz.
        // Geniş açılı lensler genelde daha düşük çözünürlüktedir. Yüksek çözünürlük talep ederek
        // cihazı ana lensi seçmeye "kibarca" ikna ediyoruz. Bu sayede hata vermeyecek.
        width: { ideal: 1920 },
        height: { ideal: 1080 }
      };
